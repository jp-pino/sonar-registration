...
if __name__ == '__main__':
    ...
    # alignment.add_module(FindNeighborsModule(registration_id, range_resolution=range_resolution, error_threshold=),
    ...
    while True:
        ...
        if a_raw.shape != b_raw.shape:
            print(f"Shapes are different: {a_raw.shape} and {b_raw.shape}")
            break
